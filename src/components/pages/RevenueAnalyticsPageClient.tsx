...
export default function RevenueAnalyticsPageClient() {
  ...
  return (
    <main className="page">
        ...
        <section className="toolbar-shell">
          <div className="toolbar-main">
            ...
            <div className="toolbar-right">
              ...
              <button className="btn btn-solid toolbar-apply" type="button" onClick={fetchData}>Apply</button>
            </div>
          </div>
        </section>
      ...
      <style jsx>{`
      .page{background:${COLORS.bg};color:#e6e9ef;min-height:100vh;font-family:'DM Sans',sans-serif}.container{max-width:1320px;margin:0 auto;padding:28px 20px 44px}.header{display:flex;justify-content:space-between;align-items:center;gap:16px;margin-bottom:18px}h1{font-size:48px;margin:0;font-weight:700}h2{margin:0 0 4px;font-size:20px}p{margin:0;color:rgba(255,255,255,.7)}.actions{display:flex;gap:10px;align-items:center}.btn{height:56px;display:inline-flex;align-items:center;justify-content:center;border-radius:8px;padding:0 24px;text-decoration:none;border:1px solid ${COLORS.border};color:#fff;background:transparent;cursor:pointer;font-size:14px}.btn-solid{background:#185FA5;border-color:#185FA5;color:#B5D4F4}.btn-outline{background:transparent}.card{background:${COLORS.card};border:1px solid ${COLORS.border};border-radius:12px;padding:16px}.toolbar-shell{background:linear-gradient(90deg,rgba(27,33,52,.45),rgba(20,24,41,.75));border:.5px solid rgba(255,255,255,.1);border-radius:14px;padding:12px 14px;box-shadow:0 8px 24px rgba(0,0,0,.25)}.toolbar-main{display:flex;gap:12px;align-items:center;justify-content:space-between}.toolbar-left{flex:1;display:grid;grid-template-columns:repeat(3,minmax(170px,1fr));gap:10px}.toolbar-right{display:flex;align-items:center;gap:10px;white-space:nowrap}.multi-filter{position:relative;min-width:0}.multi-filter span{display:none}.multi-trigger{height:46px;width:100%;display:flex;justify-content:space-between;align-items:center;text-align:left;background:${COLORS.surface};color:#e9edf5;border:.5px solid rgba(255,255,255,.14);border-radius:12px;padding:0 14px;font-size:13px;white-space:nowrap;overflow:hidden}.multi-trigger > span:first-child{overflow:hidden;text-overflow:ellipsis}.chev{opacity:.7;color:#6ea4df}.multi-menu{position:absolute;min-width:280px;z-index:30;left:0;top:52px;background:#10131f;border:.5px solid rgba(255,255,255,.14);border-radius:14px;padding:10px;box-shadow:0 12px 28px rgba(0,0,0,.4)}.menu-top{display:grid;grid-template-columns:1fr 140px;gap:10px;margin-bottom:8px}.search{height:38px;width:100%;background:#0e1322;color:#f0f4f9;border:.5px solid rgba(255,255,255,.12);border-radius:10px;padding:0 12px}.mode{height:44px;background:#02071b;color:#fff;border:.5px solid rgba(255,255,255,.15);border-radius:16px;padding:0 14px}.menu-actions{display:flex;gap:8px;margin-bottom:8px}.mini-btn{height:34px;border:.5px solid rgba(255,255,255,.12);background:#1b2238;color:#fff;border-radius:10px;padding:0 12px;font-size:12px}.tip{font-size:13px;color:#9ca8bb;margin:8px 2px}.menu-list{max-height:190px;overflow:auto;padding-right:4px;border-top:.5px solid rgba(255,255,255,.1);padding-top:8px}.menu-divider{display:none}.menu-check{display:flex;gap:10px;align-items:center;font-size:13px;color:#e6e9ef;padding:7px 4px;border-radius:6px}.menu-check:hover{background:rgba(255,255,255,.05)}.menu-check input{accent-color:${COLORS.blue};width:20px;height:20px}.done-btn{width:100%;height:52px;margin-top:10px;border:.5px solid rgba(255,255,255,.12);background:#111a34;color:#fff;border-radius:16px;font-size:16px}.toolbar-right{display:flex;align-items:center;gap:10px;justify-content:flex-end}.clear-link{border:0;background:transparent;color:#c6ccd9;font-size:13px}.toolbar-actions .btn{height:42px;border-radius:10px;background:#2d67c6;color:#dce9fb;padding:0 20px}.mode-head{font-size:12px;color:#9ba3b5;margin:2px 0 6px}.mode-radio{display:flex;gap:8px;margin-bottom:8px}.mode-radio label{display:flex;align-items:center;gap:6px;border:.5px solid rgba(255,255,255,.14);padding:6px 10px;border-radius:999px;background:#181d2d;color:#cbd5e6;font-size:12px}.mode-radio input{accent-color:#378ADD}.panel-actions{position:sticky;bottom:0;background:#10131f;display:flex;gap:8px;margin-top:10px;padding-top:8px;border-top:.5px solid rgba(255,255,255,.1)}.apply-mini{background:#2d67c6}.rows-count{font-size:12px;color:#9ea6b7}.error{margin-top:10px;color:${COLORS.red}}.kpi-grid{margin-top:14px;display:grid;grid-template-columns:repeat(6,1fr);gap:12px}.kpi .muted,.muted{font-size:12px;color:rgba(255,255,255,.55)}.kpi h3{margin:8px 0 7px;font-size:22px;font-weight:500}.mono{font-family:'DM Mono',monospace}.small{font-size:12px}.neg{color:${COLORS.red}}.pos{color:${COLORS.green}}.neutral{color:${COLORS.gray}}.divider{border-top:1px solid ${COLORS.border};margin:18px 0}.two-col{display:grid;grid-template-columns:1fr 1fr;gap:14px}.sub,.section-sub{font-size:13px;margin-bottom:12px;color:rgba(255,255,255,.6)}.section-title{margin:0}.chart-wrap{position:relative}.h220{height:220px}.h240{height:240px}.h320{height:320px}.legend{display:flex;flex-wrap:wrap;gap:12px;margin-top:10px;font-size:12px;color:rgba(255,255,255,.7)}.legend i{width:10px;height:10px;display:inline-block;border-radius:2px;margin-right:6px;vertical-align:middle}.table-wrap{overflow-x:auto}table{width:100%;border-collapse:collapse;font-size:14px}th,td{text-align:left;padding:10px;border-top:1px solid ${COLORS.border};white-space:nowrap}th{border-top:0;color:rgba(255,255,255,.55);font-size:12px;font-weight:500}.active-row td{background:rgba(55,138,221,.12)!important}.tint-red td{background:rgba(226,75,74,.05)}.badge-red{background:#FCEBEB;color:#A32D2D;border-radius:999px;font-size:12px;padding:3px 8px;font-weight:600}.mini-kpis{display:grid;grid-template-columns:repeat(5,1fr);gap:10px;margin-top:12px}.mini h4{margin:8px 0 0;font-size:20px;font-weight:500}.info-box{margin-top:12px;background:${COLORS.surface};border:1px solid ${COLORS.border};border-radius:10px;padding:10px}.foot-note{margin-top:10px;font-size:12px;color:rgba(255,255,255,.52)}
      ...
      @media (max-width:1080px){.toolbar-main{flex-direction:column;align-items:stretch}.toolbar-left{grid-template-columns:1fr 1fr}.toolbar-right{justify-content:flex-end}}@media (max-width:840px){.header{flex-direction:column;align-items:flex-start}.toolbar-left{grid-template-columns:1fr}.toolbar-right{justify-content:space-between}.two-col,.kpi-grid,.mini-kpis{grid-template-columns:1fr}.btn{height:42px;padding:0 14px;font-size:14px}.done-btn{font-size:16px;height:42px}}
      `}</style>
