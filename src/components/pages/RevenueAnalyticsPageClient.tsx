...
function MultiFilter({
  ...
  return (
    <div className="multi-filter">
      <span>{label}</span>
      <button
        className="h-10 min-w-[160px] px-3 flex items-center justify-between rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition text-sm text-slate-100"
        type="button"
      ...
      <div className="container">
        ...
        <section className="w-full">
          <div className="max-w-[1200px] mx-auto">
            <div className="flex items-center justify-between gap-4 flex-wrap rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-4 py-3">
