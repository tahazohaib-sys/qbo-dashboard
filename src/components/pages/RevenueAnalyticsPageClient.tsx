...
export default function RevenueAnalyticsPageClient() {
  ...
  return (
    <main className="page">
      ...
      @media (max-width:980px){.toolbar-grid{grid-template-columns:1fr 1fr}.toolbar-actions{grid-column:1 / -1;justify-content:flex-end}}@media (max-width:840px){.header{flex-direction:column;align-items:flex-start}.toolbar-grid{grid-template-columns:1fr}.toolbar-actions{justify-content:space-between}.two-col,.kpi-grid,.mini-kpis{grid-template-columns:1fr}.btn{height:42px;padding:0 14px;font-size:14px}.done-btn{font-size:16px;height:42px}}
      `}</style>
